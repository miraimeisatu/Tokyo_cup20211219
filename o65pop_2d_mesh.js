...
map.on("mousemove", "2DmeshLayer", function(e) {
  ...
  popup.setLngLat(e.lngLat)
    .setHTML(
      ...
      "<div><b>COVIT-19 Positive Risk（over65 01/15/2022)</b></div>" + 
...
let PTC_2020_1 = ["<", ["get", "PTC_2020"], 2000];
let PTC_2020_2 = ["all", [">=", ["get", "PTC_2020"], 2000], ["<", ["get", "PTC_2020"], 4000]];
let PTC_2020_3 = ["all", [">=", ["get", "PTC_2020"], 4000], ["<", ["get", "PTC_2020"], 8000]];
let PTC_2020_4 = ["all", [">=", ["get", "PTC_2020"], 8000], ["<", ["get", "PTC_2020"], 10000]];
let PTC_2020_5 = ["all", [">=", ["get", "PTC_2020"], 10000], ["<", ["get", "PTC_2020"], 12000]];
let PTC_2020_6 = ["all", [">=", ["get", "PTC_2020"], 12000], ["<", ["get", "PTC_2020"], 14000]];
let PTC_2020_7 = ["all", [">=", ["get", "PTC_2020"], 14000], ["<", ["get", "PTC_2020"], 16000]];
let PTC_2020_8 = ["all", [">=", ["get", "PTC_2020"], 16000], ["<", ["get", "PTC_2020"], 18000]];
let PTC_2020_9 = ["all", [">=", ["get", "PTC_2020"], 18000], ["<", ["get", "PTC_2020"], 20000]];
let PTC_2020_10 = ["all", [">=", ["get", "PTC_2020"], 20000], ["<", ["get", "PTC_2020"], 22000]];
