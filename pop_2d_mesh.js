...
map.on("mousemove", "2DmeshLayer", function(e) {
  ...
  popup.setLngLat(e.lngLat)
    .setHTML(
      ...
      "<div><b>COVIT-19 Positive Risk（01/15/2022)</b></div>" + 
...
let PT0_2020_1 = ["<", ["get", "PT0_2020"], 4000];
let PT0_2020_2 = ["all", [">=", ["get", "PT0_2020"], 4000], ["<", ["get", "PT0_2020"], 8000]];
let PT0_2020_3 = ["all", [">=", ["get", "PT0_2020"], 8000], ["<", ["get", "PT0_2020"], 12000]];
let PT0_2020_4 = ["all", [">=", ["get", "PT0_2020"], 12000], ["<", ["get", "PT0_2020"], 16000]];
let PT0_2020_5 = ["all", [">=", ["get", "PT0_2020"], 16000], ["<", ["get", "PT0_2020"], 20000]];
let PT0_2020_6 = ["all", [">=", ["get", "PT0_2020"], 20000], ["<", ["get", "PT0_2020"], 24000]];
let PT0_2020_7 = ["all", [">=", ["get", "PT0_2020"], 24000], ["<", ["get", "PT0_2020"], 28000]];
let PT0_2020_8 = ["all", [">=", ["get", "PT0_2020"], 28000], ["<", ["get", "PT0_2020"], 32000]];
let PT0_2020_9 = ["all", [">=", ["get", "PT0_2020"], 32000], ["<", ["get", "PT0_2020"], 36000]];
let PT0_2020_10 = ["all", [">=", ["get", "PT0_2020"], 36000], ["<", ["get", "PT0_2020"], 40000]];
